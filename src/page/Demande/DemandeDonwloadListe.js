...
function DemandeDonwloadListe() {
    const [demandeNouvea, setDemandes] = useState([]);
    const [demande, setDemandeDonwload] = useState([]);
        ...
        <div className="mainContenair">
            ...
            <div className="mainCo">
                ...
                <div className="TableD">
                    ...
                    <div className="boxes">
                        <div className="box box2"><Link to={"/mainCustomer/demande"} >
                            <i className="uil uil-thumbs-up"></i>
                            <span className="text">Demande Spécifique</span>
                            <span className="number">{demandeNouvea.length}</span>
                        </Link>
                        </div>
                        <div className="box box1 box-active">
                            <Link className='link' to={"/mainCustomer/demandeDonwload"} >
                        ...
                        <table>
                            ...
                            <tbody>
                                {currentdemande.map((demandes, index) => (
                                    ...
                                    <tr key={index}>
                                        <td>{demandes.id}</td><td>
                                        <Link to={`/mainCustomer/voirMicrodataC/${demandes.microdatas_id}`}>
                                        {demandes.titre}
                                </Link>
                                       </td>
...
export default DemandeDonwloadListe
