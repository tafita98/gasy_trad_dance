...
function MicrodataDetailCustomer() {
    ...
    return (
        <div class="mainCustomer">
            <div className="mainCo"  style={{  padding: '10px 15px' }}>
                <h2>Profil Microdata</h2>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '5px', backgroud: '#fff', padding: '15px 20px' }}>
...
export default MicrodataDetailCustomer
